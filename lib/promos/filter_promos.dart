...
class FilterPromos extends StatefulWidget {
  final bool inPlace;
  final PromoCategory filterCategory;
  ...
  @override
  State<FilterPromos> createState() => _FilterPromosState();
}

class _FilterPromosState extends State<FilterPromos> {
            ...
            children: [
                ...
                children: [
                  ...
                  if (chosenInPlace || chosenCity.name.isNotEmpty || chosenCategory.name.isNotEmpty)
                    ElementsOfDesign.linkButton(
                        method: (){
                          setState(() {
                            chosenCategory = PromoCategory.empty();
              ...
              ElementsOfDesign.buildTextField(
                  ...
                  onTap: () async {
                    final result = await systemMethodsClass.getPopup(
                        context: context,
                        page: const PromoCategoryPicker()
                    );
