class EventsConstants {
  ...
  static const String watchEvent = 'Просмотр мероприятия';
  ...
  static const String descEvent = 'Описание мероприятия';
  static const String eventCategory = 'Категория мероприятия';
  static const String createDateEvent = 'Дата создания мероприятия';
  static const String creatorEvent = 'Создатель мероприятия';
  static const String chooseCreator = 'Выбери создателя';
