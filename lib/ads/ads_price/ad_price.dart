...
class AdPrice {
  ...
  Map<String, String> getMap() {
    ...
    return <String, String> {
      ...
      DatabaseConstants.mainFirstSlotTwoWeeks: (sm.applyDiscountAndRoundUp(mainFirstSlot, 10)*2).toString(),
      DatabaseConstants.mainSecondSlotTwoWeeks: (sm.applyDiscountAndRoundUp(mainSecondSlot, 10)*2).toString(),
      DatabaseConstants.mainThirdSlotTwoWeeks: (sm.applyDiscountAndRoundUp(mainThirdSlot, 10)*2).toString(),
      DatabaseConstants.eventsFirstSlotTwoWeeks: (sm.applyDiscountAndRoundUp(eventsFirstSlot, 10)*2).toString(),
      DatabaseConstants.eventsSecondSlotTwoWeeks: (sm.applyDiscountAndRoundUp(eventsSecondSlot, 10)*2).toString(),
      DatabaseConstants.eventsThirdSlotTwoWeeks: (sm.applyDiscountAndRoundUp(eventsThirdSlot, 10)*2).toString(),
      DatabaseConstants.placesFirstSlotTwoWeeks: (sm.applyDiscountAndRoundUp(placesFirstSlot, 10)*2).toString(),
      DatabaseConstants.placesSecondSlotTwoWeeks: (sm.applyDiscountAndRoundUp(placesSecondSlot, 10)*2).toString(),
      DatabaseConstants.placesThirdSlotTwoWeeks: (sm.applyDiscountAndRoundUp(placesThirdSlot, 10)*2).toString(),
      DatabaseConstants.promosFirstSlotTwoWeeks: (sm.applyDiscountAndRoundUp(promosFirstSlot, 10)*2).toString(),
      DatabaseConstants.promosSecondSlotTwoWeeks: (sm.applyDiscountAndRoundUp(promosSecondSlot, 10)*2).toString(),
      DatabaseConstants.promosThirdSlotTwoWeeks: (sm.applyDiscountAndRoundUp(promosThirdSlot, 10)*2).toString(),

      DatabaseConstants.mainFirstSlotFourWeeks: (sm.applyDiscountAndRoundUp(mainFirstSlot, 20)*4).toString(),
      DatabaseConstants.mainSecondSlotFourWeeks: (sm.applyDiscountAndRoundUp(mainSecondSlot, 20)*4).toString(),
      DatabaseConstants.mainThirdSlotFourWeeks: (sm.applyDiscountAndRoundUp(mainThirdSlot, 20)*4).toString(),
      DatabaseConstants.eventsFirstSlotFourWeeks:(sm.applyDiscountAndRoundUp(eventsFirstSlot, 20)*4).toString(),
      DatabaseConstants.eventsSecondSlotFourWeeks: (sm.applyDiscountAndRoundUp(eventsSecondSlot, 20)*4).toString(),
      DatabaseConstants.eventsThirdSlotFourWeeks: (sm.applyDiscountAndRoundUp(eventsThirdSlot, 20)*4).toString(),
      DatabaseConstants.placesFirstSlotFourWeeks: (sm.applyDiscountAndRoundUp(placesFirstSlot, 20)*4).toString(),
      DatabaseConstants.placesSecondSlotFourWeeks: (sm.applyDiscountAndRoundUp(placesSecondSlot, 20)*4).toString(),
      DatabaseConstants.placesThirdSlotFourWeeks: (sm.applyDiscountAndRoundUp(placesThirdSlot, 20)*4).toString(),
      DatabaseConstants.promosFirstSlotFourWeeks: (sm.applyDiscountAndRoundUp(promosFirstSlot, 20)*4).toString(),
      DatabaseConstants.promosSecondSlotFourWeeks: (sm.applyDiscountAndRoundUp(promosSecondSlot, 20)*4).toString(),
      DatabaseConstants.promosThirdSlotFourWeeks: (sm.applyDiscountAndRoundUp(promosThirdSlot, 20)*4).toString(),
    };
  }
