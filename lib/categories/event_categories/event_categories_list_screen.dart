...
class EventCategoriesListScreen extends StatefulWidget {
  ...
  @override
  State<EventCategoriesListScreen> createState() => _EventCategoriesListScreenState();
}

class _EventCategoriesListScreenState extends State<EventCategoriesListScreen> {

  List<EventCategory> categoriesList = [];

  bool loading = false;

  bool upSorting = false;

  EventCategoriesList categoryListManager = EventCategoriesList();
  ...
  void sorting () {
    setState(() {
      upSorting = !upSorting;
      categoriesList.sortEventCategories(upSorting);
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(ScreenConstants.eventsCategoriesPage),
        actions: [
  ...
  Future<void> saveCategory(EventCategory? category) async{
    ...
    final results = await sm.pushToPageWithResult(context: context, page: EventCategoryCreateOrEditScreen(category: category));
  ...
  Future<void> deleteCategory(EventCategory category) async{
