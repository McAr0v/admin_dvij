...
class PlaceCategoryCreateOrEditScreen extends StatefulWidget {
  final PlaceCategory? category;

  const PlaceCategoryCreateOrEditScreen({this.category, Key? key}) : super(key: key);

  @override
  State<PlaceCategoryCreateOrEditScreen> createState() => _PlaceCategoryCreateOrEditScreenState();
}

class _PlaceCategoryCreateOrEditScreenState extends State<PlaceCategoryCreateOrEditScreen> {
                  ...
                  ElementsOfDesign.customButton(
                      method: () async {
                        ...
                        if (_categoryNameController.text.isEmpty){
                          ...
                          PlaceCategory publishCategory = PlaceCategory(
